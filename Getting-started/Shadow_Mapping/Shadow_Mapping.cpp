...
int main()
{
    ...
    unsigned int depthCubemap;//创建立方体贴图
    glGenTextures(1, &depthCubemap);
    glBindTexture(GL_TEXTURE_CUBE_MAP, depthCubemap);//为每个单独立方体贴图分配2D深度值纹理图像
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //参数90定义了视野的大小，90°确保视野覆盖立方体贴图的单个面
